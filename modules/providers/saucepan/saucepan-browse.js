            ...
            <div id="saucepanCharModal" class="modal-overlay hidden">
                <div class="modal-glass browse-char-modal saucepan-char-modal">
                    ...
                    <div class="browse-char-body">
                        ...
                        <div id="saucepanCharAltGreetingsSection" class="browse-char-section" style="display:none"><h3 class="browse-section-title"><i class="fa-solid fa-comments"></i> Alternate Greetings <span id="saucepanCharAltGreetingsCount" class="browse-section-count"></span><span class="browse-section-inline-toggle"></span></h3><div id="saucepanCharAltGreetings" class="browse-alt-greetings-list"></div></div>
                        <div id="saucepanCharLorebooksSection" class="browse-char-section" style="display:none"><h3 class="browse-section-title"><i class="fa-solid fa-book"></i> Linked Lorebooks <span id="saucepanCharLorebooksCount" class="browse-section-count"></span><span class="browse-section-inline-toggle"></span></h3><div id="saucepanCharLorebooks" class="saucepan-lorebooks-list"></div></div>
